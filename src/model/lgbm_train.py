...
class LGBMModel:
    ...
    def fit(self, df, month_pred):
        ...
        best_params = {'n_estimators': 500, 'reg_alpha': 4.225210678586751, 'reg_lambda': 0.4564306389521886, 'colsample_bytree': 0.5, 'subsample': 0.7, 'learning_rate': 0.008065204720928393, 'max_depth': 76, 'num_leaves': 824, 'min_child_samples': 101, 'min_data_per_groups': 63}
